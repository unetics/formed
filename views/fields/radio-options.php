<div class='opt_cl'>
	...
	<span class='sp3'>
		<label for='pcps{{$index}}'>Sub Label: </label>
		<input id='pcps{{$index}}' type='text' ng-model='el.cap2'>
	</span>
	<span class='sp3'>
		<label for='wid{{$index}}'>Width: </label>
		<input id='wid{{$index}}' type='text' ng-model='el.wid' >
	</span>
	<span class='sp2'>
	...
	<span class='sp1'>
		...
		<label for='inline3{{$index}}' class='label_radio ax' style='margin-bottom: 25px; margin-top: 18px'>
			...
			<span class='layout_c1_text'>three column</span> 
		</label>
		<label for='inline4{{$index}}' class='label_radio ax' style='margin-bottom: 25px; margin-top: 18px'>
			...
			<span class='layout_c1_text'>four column</span> 
		</label>
	</span>
</div>
...
<div class='opt_cl'>
	...
	<span class='sp3'>
		<label for='ocolor{{$index}}'>
			Color: <input class='cpicker' id='ocolor{{$index}}' ng-model='el.ocolor' style='width: 95px'>
		</label>
	</span>
	<span class='sp1'>
		<label class='label_radio tick_default' style='width: 40px'>
			<input name='tick_type{{$index}}' type='radio' ng-model='el.tick_type' value='default'>
			<div class='label_div' style='background: #fff'>
				<span class='tick_none'>Default</span>
			</div>
		</label>
		<label class='label_radio tick_default'>
			<input name='tick_type{{$index}}' type='radio' ng-model='el.tick_type' value='ticked'>
			<div class='label_div' style='background: #fff'>
				<span class='tick_default'></span>
			</div>
		</label>
		<label class='label_radio tick_circled'>
			<input name='tick_type{{$index}}' type='radio' checked='checked' ng-model='el.tick_type' value='circle-ticked'>
			<div class='label_div' style='background: #fff'>
				<span class='tick_circled'></span>
			</div>
		</label>
	</span>
</div>
...
<div class='opt_cl'>
	...
	<span class='sp1'>
		<label>
			Compulsory Field? <span style='color: #888'>(whether or not hidden by default)</span>
		</label> 
